...
namespace Mansor.Data.Migrations
{
    ...
    [Migration("20230306202525_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mansor.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "5b8a9940-faa6-4afa-9328-7cfc792d5c78",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a27bc711-57cd-4434-aab2-19540968a84a",
                            Email = "admin@mansor.net",
                            EmailConfirmed = true,
                            IsDeleted = false,
                            LockoutEnabled = false,
                            Name = "Martin Marinov",
                            NormalizedEmail = "ADMIN@MANSOR.NET",
                            NormalizedUserName = "ADMIN@MANSOR.NET",
                            PasswordHash = "AQAAAAEAACcQAAAAECfutofqIS6x0kffFri3E0YJEGjchxfmiZk0c4UjA5fSg12DdqtCVmCWJAFEDUTlgQ==",
                            PhoneNumber = "171717",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "cea722f2-b9eb-4bc9-8252-b999f50f45c4",
                            TwoFactorEnabled = false,
                            UserName = "admin@mansor.net"
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "7a71449c-da58-4532-a480-0c8c20d5d4e9",
                            ConcurrencyStamp = "6a6b7f36-3b0c-46cf-affb-f781afd6796b",
                            Name = "Administrator",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = "5b8a9940-faa6-4afa-9328-7cfc792d5c78",
                            RoleId = "7a71449c-da58-4532-a480-0c8c20d5d4e9"
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Mansor.Data.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
